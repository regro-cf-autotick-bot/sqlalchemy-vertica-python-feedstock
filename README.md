About sqlalchemy-vertica-python
===============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sqlalchemy-vertica-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11315&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqlalchemy-vertica-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqlalchemy-vertica-python` can be installed with:

```
conda install sqlalchemy-vertica-python
```

It is possible to list all of the versions of `sqlalchemy-vertica-python` available on your platform with:
